...
urlpatterns = [
    ...
    path('person/<int:pk>', PersonPageView.as_view(), name='person'), #show one person's images
    path('person/<int:pk>/add_image', add_image, name='add_image'), #add to one person's images
