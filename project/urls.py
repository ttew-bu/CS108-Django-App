...
urlpatterns = [
    ...
    path('partners', ShowAllCommunityPartnersView.as_view(), name='all_partners'), #shows all partners
    path('volunteers', ShowAllVolunteersView.as_view(), name='all_volunteers'), #shows all volunteers
    path('events', ShowAllEventsView.as_view(), name='all_events' ), #shows all events
    path('partner/<int:pk>', ShowCommunityPartnerPageView.as_view(), name='show_partner'),#shows individual partners
    path('volunteer/<int:pk>', ShowVolunteerPageView.as_view(), name='show_volunteer'),#shows individual volunteers
    path('event/<int:pk>', ShowEventPageView.as_view(), name='show_event'),#shows individual events
    path('add_volunteer', CreateVolunteerView.as_view(), name='add_volunteer'),#creates volunteers
    path('add_partner', CreatePartnerView.as_view(), name='add_partner'),#creates partners
    path('add_event', CreateEventView.as_view(), name='add_event'),#creates event
    path('volunteer/<int:pk>/update', UpdateVolunteerView.as_view(), name='update_volunteer'),#takes current vol and updates it
    path('partner/<int:pk>/update', UpdatePartnerView.as_view(), name='update_partner'),#takes current partner and updates it
    path('event/<int:pk>/update', UpdateEventView.as_view(), name='update_event'),#takes current event and updates it
    path('volunteer/<int:pk>/assign', AssignVolView.as_view(), name='assign_vol'),#takes a volunteer and assigns them to an event
    ...
    path('volunteer/<int:volunteer_pk>/add_vol_to_event/<int:event_pk>', add_volunteer_return_vol, name='add_vol_to_event'),#same as above, but redirects to a different url so that 
